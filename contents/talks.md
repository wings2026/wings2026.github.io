...
<h4 style="color:#72598b;">Families of low-genus curves on elliptic surfaces (Julie Desjardins, University of Toronto Mississauga)</h4>
<strong>Abstract:</strong> Given an algebraic variety over a field of finite type, when does it have « a lot » of rational points? The answer is often found in the curves lying on it.
It is well-known that a genus 0 curve has infinitely many points if and only if it has a point, and that a curve of genus 2 or more has finitely many points. For elliptic curves, it is not always easy to determine that information.
In the case of surfaces, the concept of « a lot » needs to be precised by properties such as unirationality or Zariski-density. Del Pezzo surfaces are interestingly only blowups away from rational elliptic surfaces (surfaces fibered in elliptic curves that are birational to $P^2$). While degree ≥ 3 del Pezzo surfaces are unirational (and thus have a Zariski-dense set of rational points), in the case where their degree is either 1 or 2, results on Zariski-density and unirationality are only partial. The strategy for proving those properties goes down to studying the low-genus multisections of the corresponding elliptic surface. Another interesting feature of constructing curves of low-degree is the possibility to find infinitely many fibers of higher rank. In this talk, I will be talking about various constructions, results and work in progress.
...
<h4 style="color:#72598b;">Women in Imperial Mathematics: Why so scarce, and can anything be done? (Charlotte Kestner, Imperial College London)</h4>
<strong>Abstract:</strong> The proportion of women students studying on the Imperial maths UG course has been in decline over the last 5 years. Only have approximately 20% of our undergraduates are women. This decline is mirrored in other elite mathematics courses, though the problem is particularly acute at Imperial, and the national picture is quite different where approximately 40% of undergraduates in the mathematical sciences are women. In this talk I will discuss work done on identifying the causes of this issue and possible interventions. I hope to have enough time at the end to have an open discussion about the issues.
...
<h4 style="color:#72598b;">Determinants of twisted Laplacians (Lejla Smajlović, University of Sarajevo)</h4>
<strong>Abstract:</strong> Determinants of Laplacians and their twisted analogues play a central role in modern mathematics, connecting spectral geometry, number theory, and topology. They encode subtle invariants of Riemann surfaces and their higher-dimensional analogues, and serve as bridges between analytic and topological torsion. Understanding these determinants not only deepens our knowledge of spectral theory but also reveals hidden structures in geometry and dynamics.
...
<details>
  ...
  <div class="contributed-talk">
  <p><strong>Ananya Satoskar</strong></p>
  <p><strong>Title: </strong>Algebraic Structure of the Torelli Group</p>
...
<details>
  ...
  <div class="contributed-talk">
  <p><strong>Laura Bradby</strong></p>
  <p><strong>Title: </strong>The maximum principle (my favourite theorem)</p>
  <p><strong>Abstract: </strong>The maximum principle is my favourite theorem, because for something so intuitively obvious, it turns out to be surprisingly useful! In this talk, we’ll take a look at the maximum principle in its simplest formulation to see its obviousness, and see one of its applications to the study of Ricci flow to showcase its utility.</p>
</div>

<div class="contributed-talk">
  <p><strong>Isabella Lewis</strong></p>
  <p><strong>Title: </strong>Ptolemy, Casey and Penner's Theorems in n-dimensions</p>
...
<div class="contributed-talk">
  <p><strong>Chiara Sabadin</strong></p>
  <p><strong>Title: </strong>Gender Diversity and Inclusivity in Mathematics</p>
  <p><strong>Abstract: </strong>Should gender diversity and inclusivity in maths still be discussed nowadays? Based on a survey made in 2025 among maths students and researchers throughout the world, the talk will provide powerful first-hand experiences on various topics (e.g. gender quotas, work-life balance, role models, menstruations).</p>
</div>
...
<div class="contributed-talk">
  <p><strong>Maartje Wisse</strong></p>
  <p><strong>Title: </strong>Domesticating the Dowlin Spectral Sequence</p>
